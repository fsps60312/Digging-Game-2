...
namespace 鑽礦遊戲2.Game_Frame.Sky_Frame.Weapon_Frame
{
    class Whirl_Gun:Gun
    {
        ...
        public Whirl_Gun(WeaponInfo info, double initialangle, bool clockwise)
        ...
        public Whirl_Gun(Planet parent, double turnaroundperiod, double bulletspeed, double fireperiod, double damage, double endurance,double initialangle,bool clockwise)
